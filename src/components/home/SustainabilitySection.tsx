...
const SustainabilitySection = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-16 md:py-32 relative bg-contain md:bg-cover bg-center text-white"
      style={{ 
        backgroundImage: 'url("https://res.cloudinary.com/dnddesigncenter/image/upload/sustainability_1_yo0sh6.avif")',
