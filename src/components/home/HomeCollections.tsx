        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <video
              ...
              loop
              playsInline
              poster="https://res.cloudinary.com/dnddesigncenter/image/upload/ludyp8ynilk1t02z9f3s.jpg"
            >
              <source
          ...
          <div className="space-y-6 md:space-y-8">
            <AnimatedSection>
              <div className="space-y-2">
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif">EXPLORE PRODUCT COLLECTION</h2>
