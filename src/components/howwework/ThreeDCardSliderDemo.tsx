...
const slides = [
  {
    ...
    icon: <span className="w-8 h-8 text-white text-3xl font-bold flex items-center justify-center">{1}</span>,
  ...
  },
  {
    ...
    icon: <span className="w-8 h-8 text-white text-3xl font-bold flex items-center justify-center">{2}</span>,
  ...
  },
  {
    ...
    icon: <span className="w-8 h-8 text-white text-3xl font-bold flex items-center justify-center">{3}</span>,
  ...
  },
  {
    ...
    icon: <span className="w-8 h-8 text-white text-3xl font-bold flex items-center justify-center">{4}</span>,
  ...
  return (
    <section className="py-24 px-4 bg-[linear-gradient(to_bottom,white_70%,#1A1A1A_60%)] min-h-screen flex items-center justify-center">
      <div className="max-w-6xl mx-auto w-full">
        <h2 className="text-6xl md:text-7xl font-serif text-black text-center mb-8">
          HOW WE WORK
        </h2>
        <p className="text-black/70 text-center max-w-1xl mx-auto mb-8 text-lg">
