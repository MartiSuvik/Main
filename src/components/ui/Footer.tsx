        ...
        <div className="flex items-center justify-between">
          ...
          <div className={`flex items-center ${isMobile ? 'space-x-3' : 'space-x-6'}`}>
            <button
              ...
              data-footer-contact
              className={`flex items-center space-x-2 font-serif rounded-lg transition-all duration-200 min-h-[44px] ${
                isMobile
            ...
            {!isMobile && (
              <button
                ...
                className="hidden md:flex items-center space-x-2 font-serif text-sm text-gray-600 hover:text-black transition-colors duration-200 group min-h-[44px]"
              >
